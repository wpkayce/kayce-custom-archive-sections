...
class KCAS_Admin {
	...
	public function render_meta_box( $post ) {
		...
		<?php /* ── Location ── */ ?>
		<div class="kcas-field-group">
			<p class="kcas-field-title"><?php esc_html_e( 'Where should this section appear?', 'kayce-custom-archive-sections' ); ?></p>
			<p class="kcas-meta-help"><?php esc_html_e( 'Choose the archive pages that will display this section.', 'kayce-custom-archive-sections' ); ?></p>
		...
		<div class="kcas-field-group" id="kcas-categories-row" style="<?php echo ( 'specific_categories' !== $location ) ? 'display:none;' : ''; ?>">
			<p class="kcas-field-title"><?php esc_html_e( 'Choose categories', 'kayce-custom-archive-sections' ); ?></p>
			<p class="kcas-meta-help"><?php esc_html_e( 'The section will appear on the archive pages for the selected categories only.', 'kayce-custom-archive-sections' ); ?></p>
		...
		<div class="kcas-field-group">
			...
			<p class="kcas-meta-help"><?php esc_html_e( 'Should this section appear before or after the list of posts?', 'kayce-custom-archive-sections' ); ?></p>
		...
		<div class="kcas-field-group">
			...
			<p class="kcas-meta-help"><?php esc_html_e( 'Control which visitors see this section.', 'kayce-custom-archive-sections' ); ?></p>
