...
class KCAS_CPT {
	...
	public function register_archive_section_cpt() {
		$labels = array(
			...
			'archives'              => __( 'Archive Section Archives', 'kayce-custom-archive-sections' ),
			'attributes'            => __( 'Archive Section Attributes', 'kayce-custom-archive-sections' ),
			'parent_item_colon'     => __( 'Parent Archive Section:', 'kayce-custom-archive-sections' ),
			'insert_into_item'      => __( 'Insert into archive section', 'kayce-custom-archive-sections' ),
			'uploaded_to_this_item' => __( 'Uploaded to this archive section', 'kayce-custom-archive-sections' ),
			'items_list'            => __( 'Archive sections list', 'kayce-custom-archive-sections' ),
			'items_list_navigation' => __( 'Archive sections list navigation', 'kayce-custom-archive-sections' ),
			'filter_items_list'     => __( 'Filter archive sections list', 'kayce-custom-archive-sections' ),
		);
